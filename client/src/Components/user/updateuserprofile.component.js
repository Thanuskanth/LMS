                    ...
                    <Modal.Body>
                        <Form onSubmit={this.onSubmit}>
                            <Form.Group as={Row} controlId="formPlaintextPassword">
                                ...
                                <Col sm="10">
                                  {this.props.isemail ?  <Form.Control type="email" placeholder="Enter New Value" onChange={this.onChange} /> : <Form.Control type="text" placeholder="Enter New Value" onChange={this.onChange} />} 
                                </Col>
